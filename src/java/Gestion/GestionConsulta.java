...
public class GestionConsulta extends Controller.ConnectionDB {
    public ArrayList<Consulta> GetConsultaIdCliente(int id_Cliente){
        super.makeConnection();
        PreparedStatement pst = null;
        ResultSet rs = null;
        ArrayList<Consulta> consultas = new ArrayList<>();
        try {
            String Query = "SELECT E.Nombre, Ce.Descripcion, Co.Fecha\n" +
            ...
            while(rs.next()){
                ...
                Consulta con=new Consulta(Nombre, Descripcion, Fecha);
                consultas.add(con);
            }
            return consultas;
        } catch (Exception e) {
